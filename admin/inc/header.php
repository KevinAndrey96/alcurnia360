...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Plataforma clientes</title>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<!--<span id="logo"> <img style="width: auto; height: 30px;" src="../img/logo.png" alt="Plataforma clientes"> </span>-->
